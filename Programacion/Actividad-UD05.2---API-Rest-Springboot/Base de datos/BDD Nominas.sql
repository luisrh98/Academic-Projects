...
-- Volcando datos para la tabla nominas.empleados: ~8 rows (aproximadamente)
REPLACE INTO `empleados` (`id`, `nombre`, `dni`, `sexo`, `categoria`, `anyos`) VALUES
	...
	(102, 'Ada Lovelace', '32000031R', 'F', 3, 0),
	(111, 'Luisito', '30264103J', 'F', 8, 8),
	(112, 'Luisa', '242344', 'F', 3, 3),
	(113, 'Lu', '7686787', 'F', 1, 0),
	(114, 'grr', '34343', 'F', 1, 0),
	(117, 'Nuevo Postman', '12345678A', 'M', 5, 10);
...
REPLACE INTO `nomina` (`id`, `dni`, `sueldo`) VALUES
	(83, '32000034', 135000.00),
	(84, '32000032G', 145000.00),
	(85, '32000031R', 90000.00),
	(93, '30264103J', 230000.00),
	(94, '242344', 105000.00),
	(95, '7686787', 50000.00),
	(96, '34343', 50000.00),
	(98, '12345678A', 180000.00);
